(function (global, factory) {
    ...
    function patch(oldVnode, vnode) {
      ...
      if (isRealElement) {
        ...
        parentNode.removeChild(oldVnode); //返回最新节点

        return elm;
      } else {
        //虚拟节点 做diff算法 新老节点比对
        console.log(oldVnode, vnode); //不是相同节点，不考虑复用 直接替换
    ...
    let render1 = compileToFunction('<div style="color:blue">{{name}}</div>'); //调用 render 函数产生虚拟节点
